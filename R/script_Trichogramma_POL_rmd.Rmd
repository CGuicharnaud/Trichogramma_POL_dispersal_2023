...
plot_dispersal <- ggplot() +
  stat_pointinterval(
    ...
    col = "grey70",
#   position = position_dodge(seed = 404, width = 0.8),
    x = position_lines,
    .width = 0.95
  ) +
  stat_eye(
...
plot_development <- ggplot() +
  stat_pointinterval(
    ...
    col = "grey70",
    x = position_lines,
#    position = position_jitter(seed = 404, width = 0.4),
    .width = 0.95
  ) +
  stat_eye(
    data = fixed_data,
...
ggsave(here("figures", "fig2.pdf"), width = 326, height = 460, dpi = 600, units = "mm")
ggsave(here("figures", "fig2.png"), width = 326, height = 460, dpi = 600, units = "mm")
```
...
figure_POL_development <- fixed_data |>
  group_by(species) |>
  mean_hdi(development_time) |> # 95 highest density interval (.width = 0.95)
...
ggsave(here("figures", "fig3.pdf"), width = 305, height = 216, dpi = 600, units = "mm")
ggsave(here("figures", "fig3.png"), width = 305, height = 216, dpi = 600, units = "mm")
```
